...
.method public constructor <init>()V
    ...
    const-string v1, "mokee.platform.app.profiles.PROFILES_STATE_CHANGED"
...
.method static synthetic access$200(Lcom/flyme/deviceoriginalsettings/profiles/ProfilesSettings;)Lmokee/app/ProfileManager;
    .locals 1
    .param p0, "x0"    # Lcom/flyme/deviceoriginalsettings/profiles/ProfilesSettings;

    .prologue
    .line 53
    iget-object v0, p0, Lcom/flyme/deviceoriginalsettings/profiles/ProfilesSettings;->mProfileManager:Lmokee/app/ProfileManager;
...
.method private setSelectedProfile(Ljava/lang/String;)V
    ...
    iget-object v2, p0, Lcom/flyme/deviceoriginalsettings/profiles/ProfilesSettings;->mProfileManager:Lmokee/app/ProfileManager;

    invoke-virtual {v2, v1}, Lmokee/app/ProfileManager;->setActiveProfile(Ljava/util/UUID;)V
    :try_end_0
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/flyme/deviceoriginalsettings/profiles/ProfilesSettings;->mProfileManager:Lmokee/app/ProfileManager;
...
.method public onEnablerChanged(Z)V
    ...
    const-string v2, "mokee.platform.app.profiles.PROFILES_STATE_CHANGED"
...
.method public refreshList()V
    ...
    .line 274
    iget-object v9, p0, Lcom/flyme/deviceoriginalsettings/profiles/ProfilesSettings;->mProfileManager:Lmokee/app/ProfileManager;

    invoke-virtual {v9}, Lmokee/app/ProfileManager;->getActiveProfile()Lmokee/app/Profile;

    move-result-object v6

    .line 275
    .local v6, "prof":Lmokee/app/Profile;
    if-eqz v6, :cond_1

    invoke-virtual {v6}, Lmokee/app/Profile;->getUuid()Ljava/util/UUID;
    ...
    invoke-virtual {v9}, Lmokee/app/ProfileManager;->getProfiles()[Lmokee/app/Profile;

    move-result-object v1

    .local v1, "arr$":[Lmokee/app/Profile;
    array-length v3, v1
    ...
    .line 278
    .local v7, "profile":Lmokee/app/Profile;
    ...
    invoke-virtual {v7}, Lmokee/app/Profile;->getUuid()Ljava/util/UUID;
    ...
    .line 284
    invoke-virtual {v7}, Lmokee/app/Profile;->getName()Ljava/lang/String;
    ...
    .line 296
    .restart local v1    # "arr$":[Lmokee/app/Profile;
